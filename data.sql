-- PostgreSQL sample data for the Hostel Management System
...
(5, 'BT2025CSE101', 'B.Tech CSE', 3, '9876543210', '{"name":"Raj Maurya","phone":"9811111111","relation":"Father"}', TRUE),
(6, 'BT2025ECE102', 'B.Tech ECE', 3, '9876543211', '{"name":"Manoj Verma","phone":"9822222222","relation":"Father"}', TRUE),
(7, 'BT2025ME103', 'B.Tech ME', 3, '9876543212', '{"name":"Sunita Patel","phone":"9833333333","relation":"Mother"}', TRUE),
(8, 'BT2025IT104', 'B.Tech IT', 3, '9876543213', '{"name":"Harjeet Kaur","phone":"9844444444","relation":"Mother"}', TRUE);
...
INSERT INTO guest_visit_requests (host_student_id, guest_name, guest_phone, guest_relation, check_in, check_out, status, assigned_guest_room_id, fee_per_night, payment_id, requested_by_user_id) VALUES
(1, 'Ravi Maurya', '9812345678', 'Brother', '2025-11-18 10:00:00+00', '2025-11-20 09:00:00+00', 'approved', 4, 400, 'GUESTPAY001', 5),
(2, 'Anjali Verma', '9823456789', 'Sister', '2025-11-22 11:00:00+00', '2025-11-23 09:00:00+00', 'pending', NULL, 400, NULL, 6);

INSERT INTO visitor_log (host_student_id, visitor_name, visitor_phone, purpose, check_in, check_out, logged_by) VALUES
(3, 'Vivek Mehta', '9876500001', 'Project Discussion', '2025-11-10 09:30:00+00', '2025-11-10 12:30:00+00', 4),
(4, 'Rohit Kaur', '9876500002', 'Family Visit', '2025-11-11 14:00:00+00', '2025-11-11 18:00:00+00', 4);

INSERT INTO complaints (student_id, room_id, category, description, status, assigned_to) VALUES
...
INSERT INTO transfer_requests (student_id, from_room_id, to_room_id, reason, status, requested_at) VALUES
(2, 1, 2, 'Wants quieter environment', 'pending', NOW()),
(4, 3, 1, 'Closer to classmates', 'rejected', NOW());

INSERT INTO waitlist (student_id, preferred_block, priority) VALUES
(2, 1, 10),
(3, 2, 15);
...
(2, 'allocate_room', '{"student_id":1,"room_id":1}'),
(2, 'approve_guest', '{"guest_id":1,"room_id":4}'),
(3, 'record_payment', '{"txn":"TXNUPI001","amount":25000}');
